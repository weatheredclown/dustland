const BROADCAST_FRAGMENT_3 = {
  ...
  "quests": [
    { "id": "q_resonant_cave", "title": "The Resonant Cave", "desc": "Follow the Hermit's instructions to activate the Resonant Crystals in the correct order.", "reward": "signal_fragment_3", "xp": 30, "reqFlag": "cave_puzzle_complete" }
  ],
  "npcs": [
    {
      "id": "cave_hermit",
      ...
      "tree": {
        "start": {
          ...
          "choices": [
            { "label": "(Accept) I will listen.", "to": "accept", "q": "accept" },
            { "label": "(Complete) I have activated the crystals.", "to": "turnin", "q": "turnin" },
            { "label": "(Leave)", "to": "bye" }
          ]
        },
  ...
  "interiors": [
    {
      ...
      "grid": [
        ...
        [1,7,1,1,7,7,7,1,1,7,1],
        [1,7,1,7,7,7,7,7,1,7,1],
        [1,7,7,7,1,7,1,7,7,7,1],
        [1,7,7,1,7,7,7,1,7,7,1],

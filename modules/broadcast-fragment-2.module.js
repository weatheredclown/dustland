const BROADCAST_FRAGMENT_2 = {
  ...
  "quests": [
    { "id": "q_silent_tower", "title": "The Silent Tower", "desc": "Find 3 Power Cells to help Echo restore power to the comms tower.", "item": "power_cell", "count": 3, "reward": "signal_fragment_2", "xp": 20 }
  ],
  "npcs": [
    {
      "id": "echo_scavenger",
      ...
      "tree": {
        "start": {
          ...
          "choices": [
            { "label": "(Accept) I'll find them.", "to": "accept", "q": "accept" },
            { "label": "(Turn in) I have 3 Power Cells.", "to": "turnin", "q": "turnin", "reqItem": "power_cell", "reqCount": 3 },
            { "label": "(Leave)", "to": "bye" }
          ]
        },
        "accept": {

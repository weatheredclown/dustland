...
- **Last updated**: 2025-12-05 by automated agent.
...
- **Lint guard**: ESLint bans `@ts-nocheck` comments in TypeScript sources to stop regressions before tests run.
...
| Date       | Summary |
| ---------- | ------- |
| 2025-12-05 | Added an ESLint guard that rejects new `@ts-nocheck` comments so regressions fail before tests run. |

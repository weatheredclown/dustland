...
- **Files remaining with `@ts-nocheck`**: 37 (12 core engine, 18 module bundles, 7 UI/tooling scripts). The count is generated by `rg "@ts-nocheck" ts-src -l | wc -l` and should trend downward after every milestone.
